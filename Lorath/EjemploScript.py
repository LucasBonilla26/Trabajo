...
def on_message(client, userdata, message):
    ...
    informacion = {
    			...
    			'tags': {'gatewayID': data['rxInfo'][0]['gatewayID']},
		           	...
		           	'brokenSensor':data['object']['brokenSensor'], 
		           	'childLock':data['object']['childLock'], 
		           	'highMotorConsumption':data['object']['highMotorConsumption'], 
		           	'lowMotorConsumption':data['object']['lowMotorConsumption'], 
		           	'motorPosition':float(data['object']['motorPosition']), 
		           	'motorRange':float(data['object']['motorRange']), 
		           	'openWindow':data['object']['openWindow'], 
		           	...
		           	'targetTemperature':float(data['object']['targetTemperature'])
                   		}
                  }
