...
print('https://saihtajo.chtajo.es/libs/sedh_lite/ajax.php?url=/sedh/ajax_obtener_tabla_numericos/param:1616579503618/origen:1d/fecha_ini:{fecha_ini}-00-00/fecha_fin:{fecha_fin}-00-00/zoom_ini:{fecha_ini}-00-00/zoom_fin:{fecha_fin}-00-00/_senal:E_37LICT01|E_37LICT01|E_37LICT01/_valor:MED|MAX|MIN/ver_detalle:1/alto:946&_=1616579503619'.format(fecha_ini=fecha_ini, fecha_fin=fecha_fin))
#Extracciondatos
m = requests.get('https://saihtajo.chtajo.es/libs/sedh_lite/ajax.php?url=/sedh/ajax_obtener_tabla_numericos/param:1615285927056/origen:1d/fecha_ini:{fecha_ini}-00-00/fecha_fin:{fecha_fin}-00-00/zoom_ini:{fecha_ini}-00-00/zoom_fin:{fecha_fin}-00-00/_senal:E_37VICT01/_valor:ULT/ver_detalle:1/alto:633&_=1615285927057'.format(fecha_ini=fecha_ini, fecha_fin=fecha_fin), verify=False, stream=True)
cota=requests.get('https://saihtajo.chtajo.es/libs/sedh_lite/ajax.php?url=/sedh/ajax_obtener_tabla_numericos/param:1616579503618/origen:1d/fecha_ini:{fecha_ini}-00-00/fecha_fin:{fecha_fin}-00-00/zoom_ini:{fecha_ini}-00-00/zoom_fin:{fecha_fin}-00-00/_senal:E_37LICT01|E_37LICT01|E_37LICT01/_valor:MED|MAX|MIN/ver_detalle:1/alto:946&_=1616579503619'.format(fecha_ini=fecha_ini, fecha_fin=fecha_fin), verify=False, stream=True)
DireccionViento=requests.get('https://saihtajo.chtajo.es/libs/sedh_lite/ajax.php?url=/sedh/ajax_obtener_tabla_numericos/param:1616581044934/origen:1d/fecha_ini:{fecha_ini}-00-00/fecha_fin:{fecha_fin}-00-00/zoom_ini:{fecha_ini}-00-00/zoom_fin:{fecha_fin}-00-00/_senal:E_37UI__12|E_37UI__12|E_37UI__12/_valor:MED|MAX|MIN/ver_detalle:1/alto:946&_=1616581044934'.format(fecha_ini=fecha_ini, fecha_fin=fecha_fin), verify=False, stream=True)
Humedad=requests.get('https://saihtajo.chtajo.es/libs/sedh_lite/ajax.php?url=/sedh/ajax_obtener_tabla_numericos/param:1616581498886/origen:1d/fecha_ini:{fecha_ini}-00-00/fecha_fin:{fecha_fin}-00-00/zoom_ini:{fecha_ini}-00-00/zoom_fin:2{fecha_fin}-00-00/_senal:E_37UI__14|E_37UI__14|E_37UI__14/_valor:MED|MAX|MIN/ver_detalle:1/alto:946&_=1616581498887'.format(fecha_ini=fecha_ini, fecha_fin=fecha_fin), verify=False, stream=True)
Pluviometro=requests.get('https://saihtajo.chtajo.es/libs/sedh_lite/ajax.php?url=/sedh/ajax_obtener_tabla_numericos/param:1616584258151/origen:1d/fecha_ini:{fecha_ini}-00-00/fecha_fin:{fecha_fin}-00-00/zoom_ini:{fecha_ini}-00-00/zoom_fin:{fecha_fin}-00-00/_senal:E_37WI__01|E_37WI__01|E_37WI__01/_valor:INT|MAX|MED/ver_detalle:1/alto:753&_=1616584258151'.format(fecha_ini=fecha_ini, fecha_fin=fecha_fin), verify=False, stream=True)
Presion=requests.get('https://saihtajo.chtajo.es/libs/sedh_lite/ajax.php?url=/sedh/ajax_obtener_tabla_numericos/param:1616584295937/origen:1d/fecha_ini:{fecha_ini}-00-00/fecha_fin:{fecha_fin}-00-00/zoom_ini:{fecha_ini}-00-00/zoom_fin:{fecha_fin}-00-00/_senal:E_37UI__15|E_37UI__15|E_37UI__15/_valor:MED|MAX|MIN/ver_detalle:1/alto:753&_=1616584295938'.format(fecha_ini=fecha_ini, fecha_fin=fecha_fin), verify=False, stream=True)
Radiacion=requests.get('https://saihtajo.chtajo.es/libs/sedh_lite/ajax.php?url=/sedh/ajax_obtener_tabla_numericos/param:1616584327777/origen:1d/fecha_ini:{fecha_ini}-00-00/fecha_fin:{fecha_fin}-00-00/zoom_ini:{fecha_ini}-00-00/zoom_fin:{fecha_fin}-00-00/_senal:E_37UI__16|E_37UI__16|E_37UI__16/_valor:MED|MAX|MIN/ver_detalle:1/alto:946&_=1616584327777'.format(fecha_ini=fecha_ini, fecha_fin=fecha_fin), verify=False, stream=True)
Temperatura=requests.get('https://saihtajo.chtajo.es/libs/sedh_lite/ajax.php?url=/sedh/ajax_obtener_tabla_numericos/param:1616584360522/origen:1d/fecha_ini:{fecha_ini}-00-00/fecha_fin:{fecha_fin}-00-00/zoom_ini:{fecha_ini}-00-00/zoom_fin:{fecha_fin}-00-00/_senal:E_37UI__13|E_37UI__13|E_37UI__13/_valor:MED|MAX|MIN/ver_detalle:1/alto:946&_=1616584360523'.format(fecha_ini=fecha_ini, fecha_fin=fecha_fin), verify=False, stream=True)
VelocidadViento=requests.get('https://saihtajo.chtajo.es/libs/sedh_lite/ajax.php?url=/sedh/ajax_obtener_tabla_numericos/param:1616584397234/origen:1d/fecha_ini:{fecha_ini}-00-00/fecha_fin:{fecha_fin}-00-00/zoom_ini:{fecha_ini}-00-00/zoom_fin:{fecha_fin}-00-00/_senal:E_37UI__11|E_37UI__11|E_37UI__11/_valor:MED|MAX|MIN/ver_detalle:1/alto:753&_=1616584397234'.format(fecha_ini=fecha_ini, fecha_fin=fecha_fin), verify=False, stream=True)
...
for var in Variables:
    ...
    if x==0:
        ...
        for m in dato:
            ...
            if m != "":
                json_body = []
                informacion = {'measurement': 'Pantano_Guijo', 'tags': {'Mancomunidad': 'Ahigal'},
        ...
        print('pasa')
        nombre = 'Pantano_Guijo_DirViento'
        med = 'Viento_Med'
        min = 'Viento_Min'
        max = 'Viento_Max'
        introducirdatos(nombre, med, max, min, date, ValMedio, ValMax, ValMin)
        ...
        nombre = 'Pantano_Guijo_Pluviometro'
        med = 'Pluviometro_Med'
        min = 'Pluviometro_Min'
        max = 'PLuviometro_Max'
        introducirdatos(nombre, med, max, min, date, ValMedio, ValMax, ValMin)
        ...
        nombre = 'Pantano_Guijo_Radiacion'
        med = 'Radiacion_Med'
        min = 'Radiacion_Min'
        max = 'Radiacion_Max'
        introducirdatos(nombre, med, max, min, date, ValMedio, ValMax, ValMin)
        ...
        nombre = 'Pantano_Guijo_TempAmbiente'
        med = 'Temperatura_Med'
        min = 'Temperatura_Min'
        max = 'Temperatura_Max'
        introducirdatos(nombre, med, max, min, date, ValMedio, ValMax, ValMin)
        ...
        nombre = 'Pantano_Guijo_VelViento'
        med = 'TVelViento_Med'
        min = 'VelViento_Min'
        max = 'VelViento_Max'
        introducirdatos(nombre, med, max, min, date, ValMedio, ValMax, ValMin)
