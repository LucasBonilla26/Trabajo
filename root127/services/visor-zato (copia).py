            ...
            if (res) {
                ...
                keys.forEach(function(key){
                    if (!names.find(ele => key == ele)) {
                        ...
                        res.demand[key]["date"] = new Date().toString()
                ...
                keys.forEach(function(key){
                    if (!names.find(ele => key == ele)) {
                        res.makers[key]["date"] = new Date().toString()
                ...
                { 
                    "Usuario" : "${ x["usuario"] != undefined ? x["usuario"] : "Desconocido"}",  
                    "Cantidad" : "${x["cantidad actual"]  != undefined ? x["cantidad actual"] : "Desconocido"}", 
                    "Entregadas" : "${x["entregadas"] != undefined ? x["entregadas"] : "Desconocido"}", 
                    "Fecha" : "${x["date"]}" 
                }`) ));
                ...
                {   
                    "Organización" : "${  x["usuario"] != undefined ? x["usuario"] : "Desconocido" }" ,
                    "Cantidad necesaria actual" : "${x["cantidad necesaria actual"]  != undefined ? x["cantidad necesaria actual"] : "Desconocido"}", 
                    "Entregadas" : "${ x["entregadas"] != undefined ? x["entregadas"] : "Desconocido" }" ,
                    "Fecha" : "${x["date"]}" 
